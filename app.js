...
function buildExportContext(activityId) {
  ...
  for (const item of items) {
    ...
    rows.push({
      ...
      emojiFallback: emojiForItemName(gear.name || ''),
    });
  }
...
<body>
  ...
  <script>
    // Auto-open the print dialog once the doc + fonts have settled. A small
    // rAF + timeout makes this robust across Chrome, Safari, and Firefox —
    // calling print() too early can print a blank page before layout is done.
